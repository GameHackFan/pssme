...
* Date:
* Description:  Forces every enemy with color IDs 4+ to use 
*               a pallete from a custom address.
*-----------------------------------------------------------------------------------------------
...
;
; 0000 6021 0022 6020 C022 0000 00FF 801D 201E A01D
; A021 E01C 0000 0000 C01B 0000 0000 401B C01B 201C
;
; D0 is safe to use.
