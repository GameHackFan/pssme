...
*-------------------------------------------------------------------------------------------------
	JMP					$7EA00.L							; Jumps the execution to the instruction in the address (replace 8F4E with this code).
...
;	ORG					$7EA00
	...
	BCS					$7EA38								; if D7 is smaller than 80, it will go to the last JMP (Less than 80 is id 3-, use original colors).
	...
	BGT					$7EA38								; if D0 is bigger than 12, go to the last JMP.
	...
	LEA					$7EA40, A0						; Stores the difference/distance between palletes start address inside the A0.
