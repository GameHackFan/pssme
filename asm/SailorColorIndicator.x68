...
; ORG				$7E850
	...
	BGE				$7E866									; If it is greater or equal 3, go to the clean print memory code.
	BSR				$7E86C									; Call the code to print the indicator for even frames.
	BSR				$7E86C									; Call the code to print the indicator for odd frames.
	RTS
	BSR				$7E8D4									; Call the code to clean the print memory space for even frames.
	BSR				$7E8D4									; Call the code to clean the print memory space for odd frames.
	RTS
	...
	BNE				$7E8BC									; If not 0, go to the code that prints it for in game select.
	...
	BEQ				$7E8B6									; If it is 2100, player 2 go to the line that moves AE to D0.
	...
	CMPI.W		#$2100, D0							; Compare 2100 and D0.
	BEQ				$7E8CE									; If it is 2100, player 2 go to the line that moves 128 to D0.
