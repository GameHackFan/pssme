...
; ORG       $7E000
                                    ...
                                    ; Block of code that tries to grab different data if it is a custom area.
  ...
  MOVE.W    ($1384, A6), D0         ; Stores ($1384 + A6) inside D0, area ID.
...
; Code 2, 3 and 4 are used as data inside the 
; level script (the game will call it).
;
