...
; ORG				$7E370
	...
	BNE				$7E37C									; If it is not player 2, jump to the ADD 100 instruction.
	...
	BNE				$7E3B4									; If they aren't equal, it will jump to the set active flag code.
	...
	ADD.W			#$01, D0								; Adds 1 to D0 (go to the next color).
	CMPI.W		#$6, D0									; Compares 6 to D0.
	BCS				$7E3B0									; If it is less, ignore the line below.
	MOVE.W		#$0, D0									; Stores 0 inside D0.
	MOVE.W		D0, ($758E, A4)					;	Stores the new color ID in the color ID memory space.

																		; Block of code that sets the color ID, sets the active flag and removes the label from the screen.
