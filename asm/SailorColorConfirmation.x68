...
*-------------------------------------------------------------------------------------------------
	JMP				$7E360.L								; Jumps the execution to the instruction in the address (replace 6374 with this code).
...
; ORG				$7E360
	...
	BNE				$7E36C									; If it is not player 2, jump to the ADD 100 instruction.
	...
	BNE				$7E39E									; If it is not 3, it will jump to original code at the end.
	...
	BNE				$7E39E									; If they aren't equal, it will jump to the set active flag code.
