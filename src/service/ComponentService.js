class ComponentService
{
  ...
  createInfoMap = () =>
  {
    ...
    im.manager = this.createComponentInfo(
        "windowContent", "Editor Manager",
        true, false);
    im.zoom = this.createComponentInfo(
        "windowContent", "Component Zoom",
        false, true);
    im.randomizer = this.createComponentInfo(
        "windowContent", "Seed Randomizer",
        false, true);
    im.patch = this.createComponentInfo(
        "windowContent", "Patch Manager",
        false, true);
    im.playerHealth = this.createComponentInfo(
        "windowContent", "Player Health Editor",
        false, true);
  ...
  createComponentInfo = (type,
      title, active, canClose) =>
  {
    let ci = {}
    ci.type = type;
    ci.title = title;
