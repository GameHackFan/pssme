export const enemyBytesMap = 
{
  ...
  yashaWitchPurpleGreen:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "71", "00"],
  yashaWitchPinkPurple:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "72", "00"],
  yashaWitchBrownPink:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "73", "00"],
  ...
  yashaWitchBrownPurpleUnused:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "76", "00"],
  yashaWitchBrownYellowUnused:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "77", "00"],
  ...
  yashaWitchBrownPinkStabbing:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "53", "00"],
  yashaWitchBrownGreenUnusedStabbing:
    ["00", "00", "03", "00",  "48", "02", "14", "00",
    "00", "00", "00", "00",   "00", "00", "54", "00"],
  ...
  garobenGreenOrange4thBoss:  // 4th Boss
    ...
    "00", "00", "00", "00",   "00", "00", "10", "00"],
  garobenGreenOrange:         // Unused Normal Enemy
    ["00", "00", "03", "00",  "48", "02", "1B", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],
  garobenGrayBrown:           // Unused Normal Enemy
    ["00", "00", "03", "00",  "48", "02", "1B", "00",
    "00", "00", "00", "00",   "00", "00", "01", "00"],
  garobenBrownGray:           // Unused Normal Enemy
    ["00", "00", "03", "00",  "48", "02", "1B", "00",
    "00", "00", "00", "00",   "00", "00", "02", "00"],
  garobenGreenBlue:           // Unused Normal Enemy
    ["00", "00", "03", "00",  "48", "02", "1B", "00",
    "00", "00", "00", "00",   "00", "00", "03", "00"],
  ...
  bakeneRunningAway:          // 7th Boss
    ["00", "00", "03", "00",  "48", "02", "1D", "00",
    "00", "00", "00", "00",   "00", "00", "20", "00"],
  bakeneExtra1Form2:          // 7th Boss
    ["00", "00", "03", "00",  "48", "02", "1D", "00",
    "00", "00", "00", "00",   "00", "00", "34", "00"],
  bakeneExtra2Form2:          // 7th Boss
    ["00", "00", "03", "00",  "48", "02", "1D", "00",
    "00", "00", "00", "00",   "00", "00", "35", "00"],
  ...
  // Extra Things
  iceRock:                    // Kunzite
    ["00", "00", "03", "00",  "48", "02", "2C", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],

  // bat:                        // Kyurene
  //   ["00", "00", "03", "00",  "48", "02", "2D", "00",
  //   "00", "00", "00", "00",   "00", "00", "00", "00"],

  npc1Capsule:                // Stage 4
    ["00", "00", "03", "00",  "48", "02", "2E", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],
  npc2Capsule:                // Stage 4
    ["00", "00", "03", "00",  "48", "02", "2E", "00",
    "00", "00", "00", "00",   "00", "00", "01", "00"],
  ...
  pingPongBomb:               // Tesuni
    ["00", "00", "03", "00",  "48", "02", "30", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],
  explosion:                  // Tesuni
    ["00", "00", "03", "00",  "48", "02", "31", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],

  shuriken:                   // Oniwabandana
    ["00", "00", "03", "00",  "48", "02", "32", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],

  shockBall:                  // Zoisite 
    ["00", "00", "03", "00",  "48", "02", "39", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],

  shockWave:                  // Kunzite
    ["00", "00", "03", "00",  "48", "02", "3A", "00",
    "00", "00", "00", "00",   "00", "00", "00", "00"],
...
/*
  Extra Things
  2C: ice rock / kunzite
  2D: bat / kyurene (do not use this)
  2E: npc inside capsule / stage 4
  2F: is the leftovers of Jumou (do not use this)
  30: ping pong bomb
  31: explosion
  32: ninja shuriken
  33: npc girl / morga (do not use this)
  34: tower / stage 3 (do not use this)
  35: door / stage 4 (do not use this)
  36: door effect / stage 4 (do not use this)
  37: nothing (do not use this)
  38: npc boy / garoben (do not use this)
  39: shock ball / zoisite
  3A: shock wave / kunzite
  3B: nothing / rose? (do not use this)
  3C: nothing / rose? (do not use this)
  3D: npc tuxedo / 4th stage (do not use this)
  3E: nothing / rose? (do not use this)
  3F: chair / 4th stage (do not use this)
  40: npc girl with cat / 7th stage (do not use this)
  41: weird creature (do not use this)
  42: frog head (do not use this)
  43: nothing (do not use this)
  44: nothing (do not use this)
  45: nothing (do not use this)
  46: crashes the game (do not use this)
  47: crashes the game (do not use this)
  48: nothing (do not use this)
  49: nothing (do not use this)
  4A: crashes the game (next ones seem to also crash the game)
*/