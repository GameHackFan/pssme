...
class PalleteEditor extends Component
{
  constructor(props)
  {
    ...
    this.onSavePalletePresetClick = 
        this.onSavePalletePresetClick.bind(this);
    this.onSaveAllPresetClick =
        this.onSaveAllPresetClick.bind(this);
  ...
  onSavePalletePresetClick(event)
  {
    ...
    {
      let preset = palleteEditorService.
  ...
  render()
  {
    return (
      <PalleteEditorComponent
        ...
        onRestorePallete={this.onRestorePallete}
